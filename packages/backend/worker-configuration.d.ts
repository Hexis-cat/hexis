/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5bc0f24dfff7e77f1de05bab58f6ecf8)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DATABASE_URL">> {}
}
